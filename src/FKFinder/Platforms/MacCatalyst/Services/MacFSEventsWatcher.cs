...
public class MacFSEventsWatcher : IFSEventsWatcher, IDisposable
{
    ...
    private void RebuildStream()
    {
        ...
        try
        {
            ...
            if (_stream == IntPtr.Zero)
            {
                Console.WriteLine("[FKFinder] FSEventStreamCreate returned null");
                return;
            }
        ...
        {
            Console.WriteLine($"[FKFinder] FSEvents RebuildStream failed: {ex.Message}");
        }
    }
        ...
        IntPtr eventPaths, IntPtr eventFlags, IntPtr eventIds)
    {
        ...
        {
            Console.WriteLine($"[FKFinder] FSEvents callback error: {ex.Message}");
        }
    }
