...
/// <summary>
/// Manages the macOS Dock right-click menu for MacExplorer.
...
public static class DockMenuHelper
{
    ...
    private static void OnOpenNewWindow(IntPtr self, IntPtr sel, IntPtr sender)
    {
        ...
        {
            Console.WriteLine("[MacExplorer] DockMenu: executing openNewWindow on main thread");
    ...
    private static void OnNavigateToFolder(IntPtr self, IntPtr sel, IntPtr sender)
    {
        ...
        try
        {
            ...
            if (repObj != IntPtr.Zero)
            {
                ...
                Console.WriteLine($"[MacExplorer] DockMenu: navigateToFolder path = {path}");
        ...
        catch (Exception ex) { Console.WriteLine($"[MacExplorer] DockMenu: navigateToFolder error - {ex.Message}"); }
    }
    ...
    {
        Console.WriteLine($"[MacExplorer] DockMenuHelper: {msg}");
