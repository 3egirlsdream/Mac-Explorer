...
# .zip 包:  bin/Release/net10.0/MacExplorer-1.0.14-macos.zip
...
xcrun notarytool submit bin/Release/net10.0/MacExplorer-1.0.14-macos.zip \
...
xcrun altool --upload-app \
  -f bin/Release/net10.0/MacExplorer-1.0.14-macos.zip \
  -t macos \
