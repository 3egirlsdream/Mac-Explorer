...
{
    [AvaloniaFact]
    public async Task TabCacheReusesAttachedListAndScrollWithoutReadingDirectory()
    {
        using var theme = new FastListTestTheme();
        await using var fixture = await TabCacheFixture.CreateAsync();
        ...
        Control scroll = original.FileListView.FindControl<ScrollViewer>("FastListHost")!;
        var detached = 0;
        ...
        Assert.Same(scroll, original.FileListView.FindControl<ScrollViewer>("FastListHost"));
        ...
        Assert.Equal(offset, list.Offset.Y);
    }
    ...
    {
        using var theme = new FastListTestTheme();
        await using var fixture = await TabCacheFixture.CreateAsync(10000);
        var first = fixture.Model.SelectedTab!;
        var other = fixture.AddTab();
        var original = fixture.Workspaces[first];
        var reads = fixture.Files.EnumerateDirectoryCallCount;
